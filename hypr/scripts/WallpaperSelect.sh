...
$HOME/.config/hypr/scripts/sddm_wallpaper.sh --normal

magick $wallDIR/$choosen_wallpaper -strip -resize 1280x720^ -blur 0x8 -quality 75 $HOME/.config/wlogout/assets/background.jpg
